...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2026 at 01:45 PM
...
(1, 'Ground Floor', '1', 60, '07:00:00', '10:00:00', 'LECTURE_HALL'),
...
(1, NULL, 1, 1, 'EVEN', 'ACCOUNTING', 'ACCOUNTS', 4, 0, 0),
(2, NULL, 1, 1, 'EVEN', 'PRINCIPLES OF PROGRAMMING LANGUAGE', 'PPLC', 4, 0, 0),
(3, NULL, 2, 1, 'EVEN', 'HINDI', 'HINDI', 1, 0, 1),
(4, NULL, 2, 1, 'EVEN', 'MARATHI', 'MARATHI', 1, 0, 1),
(6, 7, 3, 1, 'EVEN', 'GEOGRAPHICAL INFORMATION SYSTEM', 'GIS', 4, 0, 1),
(7, 6, 3, 1, 'EVEN', 'ENTERPRIZE JAVA', 'JAVA', 4, 0, 1);
...
(1, 1, 'BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY', 'B.SC.I.T.', 12);
...
CREATE TABLE `year` (
  `YEAR_NUMBER` int(11) NOT NULL,
  `YEAR_NAME` enum('FIRST YEAR','SECOND YEAR','THIRD YEAR') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
